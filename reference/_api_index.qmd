...
| [utils.VidigiStore](utils.VidigiStore.qmd#vidigi.utils.VidigiStore) | A wrapper around SimPy's Store that allows using a context manager pattern |
| [utils.VidigiPriorityStore](utils.VidigiPriorityStore.qmd#vidigi.utils.VidigiPriorityStore) | An optimized SimPy priority store that eliminates delays between resource |
| [utils.VidigiPriorityStoreLegacy](utils.VidigiPriorityStoreLegacy.qmd#vidigi.utils.VidigiPriorityStoreLegacy) | A SimPy store that processes requests with priority. |
