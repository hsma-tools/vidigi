...
class Patient:
    ...
    def __init__(self, p_id):
        ...
        # A triage priority, purely to demonstrate colouring entities by an
        # event-log column - has no effect on the patient's actual pathway here.
        self.priority = random.choice(["high", "low"])
        self.arrival = -np.inf
