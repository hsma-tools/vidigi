...
This page has been left here as it still feels like a valuable dive into the capabilities of bupaR and how you can bring vidigi logs into it, but you may wish to explore [the process mapping (DFG) page instead](../feat_process_maps/process_maps.ipynb).
:::
...
```{.python include="ex_2_model_classes.py"}
```
