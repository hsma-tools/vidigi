---
title: Adding Vidigi to a Simple simpy Model (HSMA Structure) - vidigi 1.0.0 to 1.3.1
execute:
  eval: false
format:
  html:
...
def attend_clinic(self, patient):
    ...
    with self.treatment_cubicles.request() as req:
        ...
        self.logger.log_resource_use_start(  #<<
                ...
                resource_id=treatment_cubicle.id  #<<
                )  #<<
...
#| echo: false
# Filter our dataframe down to a single run
single_run_event_log_df = my_trial.all_event_logs_df[
    my_trial.all_event_logs_df["run_number"] == 1
]
