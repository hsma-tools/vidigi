...
We will also remove the various bits of code that will track different metrics - the vidigi EventLogger class can help us with that later on too, and it's more efficient to calculate these
things after running our simulation, and keeps this logic more separate from the simulation logic, making our code easier to modify and maintain.
