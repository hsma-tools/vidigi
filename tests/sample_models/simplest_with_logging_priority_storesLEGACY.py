...
from vidigi.utils import CustomResource, populate_store, VidigiPriorityStoreLegacy
...
class Patient:
    ...
    def __init__(self, p_id, patient_priority_dist):
        ...
        priority_sample_val = patient_priority_dist.sample()

        if priority_sample_val < 0.2:
            self.priority = 1
        else:
            self.priority = 2
...
class Model:
    ...
    def generator_patient_arrivals(self):
        ...
        while True:
            ...
            p = Patient(self.patient_counter, self.patient_priority_dist)
