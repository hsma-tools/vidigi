...
trial_cases = [
    ...
    (
        {"trial_cls": simplest_with_logging_priority_resources, "run_kwargs": {}},
        {
    ...
    (
        {"trial_cls": simplest_with_logging_priority_storesLEGACY, "run_kwargs": {}},
        {
            "trial_cls": simplest_with_logging_priority_stores,
            "run_kwargs": {"use_populate_store_func": False},
            "drop_resource_id": False,
